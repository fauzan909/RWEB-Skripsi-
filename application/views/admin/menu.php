...
<div class="container">
	<div id="menu">
		<ul class="nav nav-tabs">
			...
			<li class="<?php if($active=='dosen')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewDosen">Pembimbing</a></li>
			<li class="<?php if($active=='ruangan')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewRuangan">Ruangan</a></li>
			<li class="<?php if($active=='kelas')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewKelas">Penguji</a></li>
